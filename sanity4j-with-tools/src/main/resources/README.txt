...
binary distribution from http://sanity4j.sourceforge.net/ .
...
This directory contains the Sanity4J tool and all the analysis tools which it
depends on. Sanity4J is designed to run quality assurance analysis on Java 
projects using the Apache ANT build tool (http://ant.apache.org) or 
via a stand-alone UI.
...
------------------------------------------------------------------------------
   ...
   sanity4j
     |__ docs         	     -- documentation / user guides
     |__ tools			     -- Tools which Sanity4J depends on
     |__ LICENSE.*.txt       -- various licenses for the third party libs
     |__ LICENSE.txt         -- the licence for the Sanity4J binary distribution
     \__ README.txt          -- this read-me file

   You will probably want to follow the instructions in the next section
   in order to start using the tool.
