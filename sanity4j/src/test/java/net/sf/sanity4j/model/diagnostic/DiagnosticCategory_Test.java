...
public class DiagnosticCategory_Test extends TestCase
{
    ...
    public void testGetDiagnosticCount()
    {
        ...
        assertEquals("getDiagnosticCount incorrect for root", 
                     2, root.getDiagnosticCount());
        assertEquals("getDiagnosticCount incorrect for child", 
                     2, child.getDiagnosticCount());
        assertEquals("getDiagnosticCount incorrect for grandchild", 
                     1, grandChild.getDiagnosticCount());
        
        assertEquals("getDiagnosticCount sev=all incorrect for root", 
                     2, root.getDiagnosticCount(Diagnostic.SEVERITY_ALL));
        assertEquals("getDiagnosticCount sev=all incorrect for child", 
                     2, child.getDiagnosticCount(Diagnostic.SEVERITY_ALL));
        assertEquals("getDiagnosticCount sev=all incorrect for grandchild", 
                     1, grandChild.getDiagnosticCount(Diagnostic.SEVERITY_ALL));
        
        assertEquals("getDiagnosticCount sev=moderate incorrect for root", 
                     1, root.getDiagnosticCount(Diagnostic.SEVERITY_MODERATE));
        assertEquals("getDiagnosticCount sev=moderate incorrect for child", 
                     1, child.getDiagnosticCount(Diagnostic.SEVERITY_MODERATE));
        assertEquals("getDiagnosticCount sev=moderate incorrect for grandchild", 
                     1, grandChild.getDiagnosticCount(Diagnostic.SEVERITY_MODERATE));        
        
        assertEquals("getDiagnosticCount sev=high incorrect for root", 
                     1, root.getDiagnosticCount(Diagnostic.SEVERITY_HIGH));
        assertEquals("getDiagnosticCount sev=high incorrect for child", 
                     1, child.getDiagnosticCount(Diagnostic.SEVERITY_HIGH));
        assertEquals("getDiagnosticCount sev=high incorrect for grandchild", 
    ...
    public void testSubCategoriesIterator()
    {
        ...
        assertTrue("Iterator next should be a DiagnosticCategory", 
                   next instanceof DiagnosticCategory);
        
        DiagnosticCategory child = (DiagnosticCategory) next; 
        assertSame("Child's parent should be the root node", 
