...
public class RuleCatalogueWriter 
{
    ...
    public void writeRuleCatalogue() throws IOException
    {
        ...
        xml.append("<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n"
                 ...
                 + "<rules qaVersion=\"").append(QAProcessor.QA_VERSION)
        ...
        for (DiagnosticProperty property : diagnosticProperties)
        {
            ...
            {
                xml.append("<rule name=\"").append(diag.getRuleName())
                    .append("\" tool=\"").append(diag.getSourceDescription())
                    .append("\" severity=\"").append(diag.getSeverity())
                    .append("\"/>\n");
            }
        }
    ...
    private List<DiagnosticProperty> getDiagnosticProperties() throws IOException
    {
        ...
        properties.load(Diagnostic.class.getResourceAsStream("Diagnostic.properties"));
    ...
    /**
     * Return the source of a Diagnostic, given a tool name.
     * This is the reverse of Diagnostic.getSourceDescription.
     * 
