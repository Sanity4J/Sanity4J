...
Customising Sanity4J analysis
  ...
  attempts to read external configuration from a standard Java properties named "sanity4j.properties" 
  located in the working directory or the user's home directory.
...
*------------+--------------------------------------------------+------------------------------------+------------------------------+
| ID         | Tool                                             | Description                        | Supported versions           |
*---------------------------------------------------------------+------------------------------------+------------------------------+
